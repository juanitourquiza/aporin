...
<div class="content">
     <div class="sidebar">
        <div class="gadget">
          <div class="clr"></div>
          <!--ul class="sb_menu">
            <li><a href="<?php //echo base_url()?>/index.php/categorias/2">Base de Datos</a></li>
            <li><a href="<?php //echo base_url()?>/index.php/categorias/3">Programaci&oacute;n</a></li>
            <li><a href="<?php //echo base_url()?>/index.php/categorias/1">Desarrollo Web</a></li>
            <li><a href="<?php //echo base_url()?>/index.php/categorias/4">Software Libre</a></li>
            <li><a href="<?php //echo base_url()?>/index.php/categorias/5">Redes</a></li>
          </ul-->
...
<div id="main"><!--a href=".">Main Demo</a-->
    ...
    <div id="sidetree">
        ...
        <div id="sidetreecontrol"><a href="?#">Contraer Men&uacute;</a> | <a href="?#">Expandir Men&uacute;</a></div>

        <ul id="tree">
            <li><a href="<?php echo base_url()?>"><strong>Home</strong></a>
                <!--ul>
            ...
            <li><span><strong>Inform&aacute;tica</strong></span>
                <ul>
                    <li><span><strong></strong>Programaci&oacute;n</span>
                        <ul>
                            <li><a href="<?php echo base_url()?>index.php/categorias/mostrar/1">Desarrollo web</a></li>
                    ...
                    <li><a href="<?php echo base_url()?>index.php/categorias/mostrar/5">Base de Datos </a>
                    <li><a href="<?php echo base_url()?>index.php/categorias/mostrar/7">Diseño Gráfico </a>
                    <li><a href="<?php echo base_url()?>index.php/categorias/mostrar/3">Redes </a>
                    <li><a href="<?php echo base_url()?>index.php/categorias/mostrar/4">Software Libre </a>
                    <li><a href="<?php echo base_url()?>index.php/categorias/mostrar/2">Seguridad Informatica </a>
                        <!--ul>
            ...
            <li><span><strong>web 2.0</strong></span>
                <ul>
                    <li><a href="<?php echo base_url()?>index.php/categorias/mostrar/6">Redes Sociales</a>
                </ul>
            </li>
            <li><span><strong>Economia y Finanzas</strong></span>
                <ul>
                    <li><a href="<?php echo base_url()?>index.php/categorias/mostrar/8">Economia</a>
                    <li><a href="<?php echo base_url()?>index.php/categorias/mostrar/9">Finanzas</a>
                </ul>
            </li>
            <li><span><strong>Noticias Importantes</strong></span>
                <ul>
                    <li><a href="<?php echo base_url()?>index.php/categorias/mostrar/10">Noticias</a>
                </ul>
            </li>
            <li><span><strong>Varios</strong></span>
                <ul>
                    <li><a href="<?php echo base_url()?>index.php/categorias/mostrar/13">Empleos</a>
                    <li><a href="<?php echo base_url()?>index.php/categorias/mostrar/12">Sin Categoria</a>
                </ul>
            </li>
...
<a href="http://twitter.com/aporinweb" class="twitter-follow-button" data-show-count="false" data-lang="es">Follow @aporinweb</a>
...
}).render().setUser('aporinweb').start();
</script>
